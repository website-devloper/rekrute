...
<html lang="en">
<head>
    <title>Code Verification - Rekrify</title>
    <meta charset="UTF-8">
    ...
    <!-- Reuse Premium Style from forgot_password -->
    <style>
        :root {
            --primary: #6366f1;
            --primary-dark: #4f46e5;
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .forgot-icon i { font-size: 1.5rem; color: var(--success); }
...
<body>
    ...
    <div class="forgot-container">
        <div class="forgot-card">
            ...
            <form action="#" method="POST" onsubmit="event.preventDefault(); window.location.href='{{ route('new_password') }}'">
                <div class="form-group">
                    <label class="form-label text-center">Verification Code</label>
                    <div class="input-wrapper">
                        <input type="text" name="code" class="form-input" placeholder="0000" maxlength="4" required>
                    </div>
                </div>

                <a href="{{ route('new_password') }}" class="btn-submit">
                    Verify & Proceed
                    <i class="fas fa-arrow-right"></i>
                </a>
            </form>

            <a href="{{ route('forgot_password') }}" class="back-link">
