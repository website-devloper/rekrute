...
<html lang="en">
<head>
    <title>Set New Password - Rekrify</title>
    <meta charset="UTF-8">
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .forgot-header h1 { font-family: 'Outfit', sans-serif; font-size: 1.75rem; font-weight: 700; color: var(--gray-900); margin-bottom: 0.5rem; }
        .forgot-header p { color: var(--gray-500); font-size: 0.9375rem; line-height: 1.6; }
        ...
        .form-input {
            width: 100%; padding: 0.9375rem 1rem 0.9375rem 3rem;
            border: 2px solid var(--gray-200); border-radius: 12px; font-size: 1rem;
            color: var(--gray-900); transition: all 0.2s;
        }
        ...
        .btn-submit {
            ...
            gap: 0.5rem; box-shadow: 0 4px 15px rgba(99, 102, 241, 0.35); text-decoration: none;
        }
    ...
    <div class="forgot-container">
        <div class="forgot-card">
            ...
            <form action="#" method="POST">
                ...
                <a href="{{ route('password_reset_success') }}" class="btn-submit">
                    Reset Password
                </a>
            </form>
        </div>
