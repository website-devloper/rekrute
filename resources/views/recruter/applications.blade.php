...
<div class="dashboard-wrapper">
    ...
    <main class="dashboard-main">
        <div class="page-header">
            <div>
                <a href="{{ route('recruiter.jobs') }}" class="back-link"><i class="fas fa-arrow-left"></i> Back to Jobs</a>
        ...
        <div class="filter-bar">
            <form action="{{ route('recruiter.job.applications', $job->id) }}" method="GET" class="filter-form">
        ...
        <div class="applications-grid">
            ...
            <div class="application-card" data-aos="fade-up">
                ...
                <div class="card-body">
                    ...
                    <p class="applicant-title">{{ $application->candidate->job_title ?? 'No title provided' }}</p>
                    
                    <div class="meta-info">
                        <span><i class="fas fa-clock"></i> {{ $application->created_at->diffForHumans() }}</span>
                        @if($application->candidate && $application->candidate->city)
                        <span><i class="fas fa-map-marker-alt"></i> {{ $application->candidate->city }}</span>
                        @endif
                    </div>
            ...
            <div class="empty-state">
                ...
                <p>Wait for candidates to apply or promote your job posting.</p>
            </div>
            @endforelse
        </div>
...
<style>
    ...
    .back-link { display: inline-flex; align-items: center; gap: 0.5rem; color: var(--primary); text-decoration: none; font-weight: 500; margin-bottom: 0.5rem; }
    ...
    .status-badge.reviewed { background: rgba(59, 130, 246, 0.1); color: #6366f1; }
    ...
    .applicant-title { color: var(--primary); font-weight: 600; font-size: 0.875rem; margin-bottom: 1rem; }
